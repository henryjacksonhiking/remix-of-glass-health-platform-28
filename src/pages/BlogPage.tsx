...
const articles = [
  { title: "How to reduce patient no-shows with automated reminders", category: "Patient engagement", date: "March 2026", readTime: "5 min read" },
  { title: "The hidden cost of manual appointment management", category: "Clinic operations", date: "March 2026", readTime: "4 min read" },
  { title: "Digital intake forms: a step-by-step implementation guide", category: "Automation", date: "February 2026", readTime: "6 min read" },
  { title: "Why online payments improve clinic cash flow", category: "Revenue growth", date: "February 2026", readTime: "4 min read" },
  { title: "Building a patient-first digital experience", category: "Patient engagement", date: "January 2026", readTime: "5 min read" },
  { title: "EHR integration: what clinics need to know", category: "Clinic operations", date: "January 2026", readTime: "7 min read" },
];
          ...
          {categories.map((cat, i) => (
            <button
              ...
              className={`text-sm px-4 py-2 rounded-lg transition-colors ${
                i === 0 ? "bg-primary/10 text-primary" : "glass-panel text-muted-foreground hover:bg-glass-hover"
              }`}
            >
              {cat}
            </button>
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-4xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {articles.map((article, i) => (
            ...
            >
              <div className="glass-panel p-6 h-full flex flex-col hover:bg-glass-hover transition-colors cursor-pointer">
                <span className="text-xs text-primary font-medium mb-3">{article.category}</span>
                <h3 className="text-base font-medium text-foreground mb-3 flex-1">{article.title}</h3>
